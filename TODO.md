...
- [ ] `P1` Přepsat refresh mapy na inkrementální synchronizaci místo pravidelného stahování celého datasetu.
- [ ] `P1` Přidat serverovou/klientskou podporu pro `since` / `lastId` / `lastTimestamp`, aby se po 10 s dotahovaly jen nové body.
